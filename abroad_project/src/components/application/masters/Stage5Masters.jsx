...
//       {/* Main Content */}
//       <div className="md:w-3/4 w-full bg-white p-4 h-screen md:overflow-auto">
//       <div className="bg-gradient-to-r from-[#ffffff] to-blue-300 p-2 text-center text-2xl font-semibold flex items-center cursor-pointer"
//         onClick={() => setIsUniSelectionOpen((o) => !o)}>
//         <p className="text-2xl font-semibold text-center">University Selection</p>
//         {isUniSelectionOpen ? (
//           <MdOutlineExpandLess className="ml-auto text-4xl" />
//         ) : (
//           <MdOutlineExpandMore className="ml-auto text-4xl" />
...
//       {isUniSelectionOpen && (
//         <div>
//           <div className="w-1/2 bg-amber-500 rounded-full px-5 py-2 mt-4 font-semibold">SESSION IV - University Selection</div>
//             {/* Video */}
//             <iframe
//               src={videoUrl1}
//               className="w-full h-[300px] md:h-[400px] mt-2 mb-4"
...
//               allowFullScreen
//             />
//             <a href="mailto:abroadunbox@gmail.com" className="w-1/2 bg-yellow-300 rounded-full px-5 py-2 mt-4 font-semibold shadow-lg hover:bg-yellow-400">Request Appointment</a>
//         </div>
//       )}
...
//        <h2 className="text-xl font-semibold mb-2">University Profile:</h2>
//        <p>We shall create a comprehensive report on the important things about your chosen university that you have to work on. This information will be saved and you can always refer back on for referencing when comparing your universities.</p>
