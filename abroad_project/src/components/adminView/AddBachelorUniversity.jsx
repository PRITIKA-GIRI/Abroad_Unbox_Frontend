// src/components/AddBachelorUniversity.jsx
...
const initialFormData = {
  ...
  university_level: "bachelor",
};

export default function AddBachelorUniversity({ onAdded }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Bachelor-level university added!");
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="text-center">
        ...
        >
          {loading ? "Submitting..." : "Add Bachelor University"}
        </button>
      </div>
    </form>
  );
